...
const VenuesPage = () => {
  ...
  const handleDeleteVenue = async (venueId) => {
    ...
    try {
      ...
      if (events && events.length > 0) {
        alert('This venue cannot be deleted because it is used in existing events.');
        return;
      }
  ...
  const handleSaveVenue = async (venueData, venueId = null) => {
    try {
      ...
      // Delete existing zones and seats for this venue
      if (venueId) {
        // Delete zones
  ...
  return (
    <div className="container mx-auto max-w-[960px] px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Venues</h1>
        <button
      ...
      {loading && venues.length === 0 ? (
        ...
        <div className="bg-zinc-100 dark:bg-zinc-800 rounded-lg p-8 text-center">
          <h2 className="text-xl font-medium mb-2 text-zinc-900 dark:text-white">No Venues Yet</h2>
          <p className="text-zinc-600 dark:text-zinc-400 mb-6">
            Create your first venue to start managing events and seating.
          </p>
          <button
            onClick={handleCreateVenue}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {venues.map(venue => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-lg font-medium text-zinc-900 dark:text-white mb-1">{venue.name}</h3>
